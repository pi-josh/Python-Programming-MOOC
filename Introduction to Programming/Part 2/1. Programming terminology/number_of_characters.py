...
among other things. The function returns the number of characters
in a string.
...
Please write a program which asks the user for a word and then
prints out the number of characters, if there was more than one
typed in.
